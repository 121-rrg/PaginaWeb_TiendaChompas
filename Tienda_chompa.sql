...
DESCRIBE producto;
INSERT INTO producto VALUES(1,'rojo oscuro',40.00,'NIKE','S');
INSERT INTO producto VALUES(2,'verde claro',30.00,'ADIDAS','XL');
INSERT INTO producto VALUES(3,'cafe claro',35.00,'PUMBA','M');
INSERT INTO producto VALUES(33,'Color negro',240.00,'Nike','S');
INSERT INTO producto VALUES(4,'Color azul',240.00,'Adidas','S');
INSERT INTO producto VALUES(5,'Color marron',240.00,'Nike','M');
INSERT INTO producto VALUES(6,'Color ocre',200.00,'Lacoste','S');
INSERT INTO producto VALUES(7,'Color naranja',140.00,'Nike','M');
INSERT INTO producto VALUES(8,'Color azul',40.00,'Nike','S');
...
/* Insertando el producto en la tabla p_masculino*/
INSERT INTO p_masculino VALUES(2,95);
INSERT INTO p_masculino VALUES(33,44);
INSERT INTO p_masculino VALUES(4,40);
INSERT INTO p_masculino VALUES(5,20);
INSERT INTO p_masculino VALUES(6,50);

/* Insertando el producto en la tabla p_femenino*/
...
/* Insertando el producto en la tabla p_unisex*/
...
/*Insertando compra id_compra ,id_producto ,dni_cliente ,dni_vendedor ,cantidad */
DESCRIBE compra;
...
/*Tienda unica por el momento*/
DESCRIBE tienda;
INSERT INTO tienda VALUES(1234567,124,'Av.Santa Marta',98754321,'Nuevo Sol');
SELECT* FROM tienda;
DESCRIBE reclamo;
INSERT INTO reclamo VALUES( null, 72249616,"Mala atencion");
SELECT * from reclamo;
